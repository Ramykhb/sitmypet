...
const TabIcon = ({ focused, icon, title }: any) => {
  return (
    <View style={{ flex: 1, minWidth: 85, minHeight: 58, marginTop: 31, justifyContent: "center", alignItems: "center" }}>
        ...
        screenOptions={{
          ...
          tabBarBackground: () => (
            ...
            >
              ...
              />
              <View style={{ ...StyleSheet.absoluteFillObject, backgroundColor: "rgba(120,120,120,0.08)" }} />
            </BlurView>
          ),
        }}
      >
        ...
        <Tabs.Screen
          ...
          listeners={{
            focus: () => Animated.spring(indicatorX, { toValue: step * 2 - 1, useNativeDriver: true }).start(),
          }}
        />
        ...
        <Tabs.Screen
          ...
          listeners={{
            focus: () => Animated.spring(indicatorX, { toValue: step * 3 - 3, useNativeDriver: true }).start(),
          }}
        />
      </Tabs>
    </SafeAreaProvider>
