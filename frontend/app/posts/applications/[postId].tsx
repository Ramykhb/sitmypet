                          ...
                          renderItem={({item}) => (
                              ...
                              <View className="w-full h-20 flex flex-row px-10 mt-1 mb-2 items-center">
                                  ...
                                  <View className={"flex flex-row items-center"}>
                                      <View className={"bg-[#fcb3b3] h-10 w-10 rounded-full flex items-center justify-center mr-4"}>
                                          <Image source={require("../../../assets/icons/close.png")} className={"w-6 h-6"} tintColor={"#DC2626"} />
                                      </View>
                                      <View className={"bg-[#cacbed] h-10 w-10 rounded-full flex items-center justify-center"}>
                                          <Image source={require("../../../assets/icons/tick.png")} className={"w-6 h-6"} tintColor={"#3944D5"} />
                                      </View>
                                  </View>
                              </View>
